...
#ifndef __PointCloud2_t_hpp__
#define __PointCloud2_t_hpp__
...
class PointCloud2_t
{
    public:
        ...
        std::vector< PointField_t > fields;
...
int PointCloud2_t::_encodeNoHash(void *buf, int offset, int maxlen) const
{
    ...
    tlen = __int32_t_encode_array(buf, offset + pos, maxlen - pos, &this->field_num, 1);
    if(tlen < 0) return tlen; else pos += tlen;

    for (int a0 = 0; a0 < this->field_num; a0++) {
    ...
    if(this->point_num > 0) {
        tlen = __int8_t_encode_array(buf, offset + pos, maxlen - pos, &this->data[0], this->point_num);
        if(tlen < 0) return tlen; else pos += tlen;
    }
...
int PointCloud2_t::_decodeNoHash(const void *buf, int offset, int maxlen)
{
    ...
    tlen = __int32_t_decode_array(buf, offset + pos, maxlen - pos, &this->field_num, 1);
    if(tlen < 0) return tlen; else pos += tlen;

    try {
        this->fields.resize(this->field_num);
    } catch (...) {
        return -1;
    }
    for (int a0 = 0; a0 < this->field_num; a0++) {
    ...
    if(this->point_num) {
        this->data.resize(this->point_num);
        tlen = __int8_t_decode_array(buf, offset + pos, maxlen - pos, &this->data[0], this->point_num);
        if(tlen < 0) return tlen; else pos += tlen;
    }
...
int PointCloud2_t::_getEncodedSizeNoHash() const
{
    ...
    enc_size += __int32_t_encoded_array_size(NULL, 1);
    enc_size += __int32_t_encoded_array_size(NULL, 1);
    enc_size += __int8_t_encoded_array_size(NULL, this->point_num);
    return enc_size;
}
